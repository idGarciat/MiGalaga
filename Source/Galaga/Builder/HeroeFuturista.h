...
#include "HeroeFuturista.generated.h"

UCLASS()
class GALAGA_API AHeroeFuturista : public AActor, public ICreadorHeroes
{
	GENERATED_BODY()
...
public:
	...
	class UMaterial* Material1 = LoadObject<UMaterial>(nullptr, TEXT("Material'/Game/MeshCustom/9236af7611d6_Big_Space_Ship_like_roughness_Mat.9236af7611d6_Big_Space_Ship_like_roughness_Mat'"));
